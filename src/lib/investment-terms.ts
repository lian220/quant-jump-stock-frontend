...
export const INVESTMENT_TERMS: Record<string, InvestmentTerm> = {
  ...
  cagr: {
    label: '연평균 수익률',
    alias: 'CAGR (Compound Annual Growth Rate)',
    description: '매년 꾸준히 이 비율로 성장했다고 가정한 연평균 복리 수익률입니다.',
  },
  mdd: {
    label: '최대 손실폭',
    alias: 'MDD (Maximum Drawdown)',
    description:
      '투자 기간 중 최고점에서 최저점까지 가장 크게 떨어진 비율입니다. 값이 작을수록 안정적입니다.',
  },
  sharpeRatio: {
    label: '안정성 지수',
    alias: '샤프 비율 (Sharpe Ratio)',
    description:
  ...
  stopLoss: {
    label: '손절',
    alias: '스탑로스 (Stop Loss)',
    description: '일정 수준 이상 손실이 발생하면 추가 손실을 막기 위해 자동으로 매도하는 것입니다.',
  },
  riskLevel: {
    label: '위험도',
    alias: '리스크 레벨 (Risk Level)',
    description:
      '전략의 위험 수준을 나타냅니다. 낮음/중간/높음으로 구분되며, 최대 손실폭(MDD) 기준으로 산정됩니다.',
  },
  cagrCompound: {
    label: '연평균 수익률(복리)',
    alias: 'CAGR (복리)',
